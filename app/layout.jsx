...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon-purple-32x32.png', sizes: '32x32', type: 'image/png' },
      { url: '/favicon-purple-48x48.png', sizes: '48x48', type: 'image/png' },
      { url: '/favicon-purple-192x192.png', sizes: '192x192', type: 'image/png' },
      { url: '/favicon-purple-512x512.png', sizes: '512x512', type: 'image/png' },
    ],
